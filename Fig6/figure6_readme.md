## Figure 6
This figure covers the case of a nonlinear quadrotor model motion with quadrotors circling a static target with <img src="https://render.githubusercontent.com/render/math?math=\bar{\omega} = 0.1"> rad/s, with wind  <img src="https://render.githubusercontent.com/render/math?math=v_a = [2,2,0]^T"> m/s and sensor noise and complete information control<br>
...
<img src="https://render.githubusercontent.com/render/math?math=K_{Dr} = 0.5"><br>
