## Figure 6
This figure covers the case of a kinematic model of quadrotor motion and a static target. No wind or sensor noise is considered here. Control is applied along the line-of-sights of the quadrotors and target. No lateral control is applied. The gains for the simulation are:<br>
